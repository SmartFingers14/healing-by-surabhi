...
import { ArrowRight, CheckCircle, ArrowLeft, Sparkles } from "lucide-react";
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.3 }}>
              <div className="sticky top-28 bg-white rounded-2xl p-6 border border-saffron-200 shadow-lg">
                ...
                <Link href="/contact" className="btn-shimmer w-full flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-temple-gold to-temple-copper text-white font-semibold rounded-full mb-3">
